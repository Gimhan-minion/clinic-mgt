...
<head>
    ...
    <link rel="shortcut icon" type="image/jpg" href="./scenes/images/favicon.ico"/>
    <meta charset="utf-8">
...
<body class="bg">
<?php include 'scenes/nav.php' ?>
<form method="post">
    <div class="container features">
        <div class="row center">
            <div class="col-md-8 CardBgCol">
                <h3 class="feature-title">Patient Registration Form</h3>
                ...
                <div class="form-group">
                    Contact Number:
                    <input type="number" class="form-control" name="con_num" required>
                </div>
                <div class="form-group">
                    Birth Date:
              ...
              <div class="form-group">
                ...
                <input type="submit" class="btn btn-primary" value="Create Account" name="btnCreate"
    ...
    if (isset($_POST['btnCreate'])) {
        try {
          if($md5pw == $md5cpw){
              ...
              echo "<script> alert('Patient Password doesn\'t match');</script>";
          }
...
error_reporting(E_ALL & ~E_WARNING & ~E_NOTICE);
?>
<img src="scenes/images/background.jpg" class="img-bg">
